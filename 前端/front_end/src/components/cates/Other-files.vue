<template>
  <div class="container">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>其他文件</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <el-card class="box-card">
      ...
      <el-table :data="callBack" stripe style="width: 100%">
        ...
        <el-table-column prop="my_file_name" label="名称"></el-table-column>
        <el-table-column prop="type" label="类型"></el-table-column>
        <el-table-column prop="postfix" label="扩展名"></el-table-column>
        <el-table-column prop="size" label="大小"></el-table-column>
        <el-table-column prop="download_time" label="下载次数"></el-table-column>
        <el-table-column prop="upload_time" label="上传日期"></el-table-column>-->
...
export default {
  ...
  methods: {
    ...
    async getTextList() {
      this.situationUrl =
        'http://fangyulong.online:8702/getOther?openid=' + this.openId
